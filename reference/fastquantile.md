...
#>            {     fastquantile(x, 0.5) }  64.641 122.5840 135.8601 133.8550
#>  {     quantile(x, 0.5, na.rm = TRUE) } 284.281 301.1275 353.7836 319.8175
#>         {     median(x, na.rm = TRUE) } 206.055 219.2000 260.8122 227.6805
#>       uq     max neval
#>  151.553 190.106   100
#>  440.693 490.036   100
#>  252.161 397.303   100
