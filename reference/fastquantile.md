...
#>            {     fastquantile(x, 0.5) }  72.295 116.4625 131.1370 126.1260
#>  {     quantile(x, 0.5, na.rm = TRUE) } 286.174 302.5100 358.9258 315.6190
#>         {     median(x, na.rm = TRUE) } 206.546 221.2930 267.9973 228.0555
#>        uq     max neval
#>  152.2290 184.414   100
#>  462.4380 510.293   100
#>  343.0005 415.175   100
```
