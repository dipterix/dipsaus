...
register_screenshot( Shiny, src_DEBUG );
register_set_input( Shiny, src_DEBUG );
register_swal( Shiny, src_DEBUG );
register_directoryInput( Shiny, src_DEBUG );
register_streamDownload( Shiny, src_DEBUG );
