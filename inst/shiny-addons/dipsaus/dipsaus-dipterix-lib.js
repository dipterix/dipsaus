...
;// ./src/shiny-input-actionbutton2.js
...
var sweetalert_min = __webpack_require__(158);
var sweetalert_min_default = /*#__PURE__*/__webpack_require__.n(sweetalert_min);
;// ./src/shiny-input-swal.js



const close_current = () => {
  sweetalert_min_default().stopLoading();
  sweetalert_min_default().close();
}
...
const register_swal = (Shiny, debug = false) => {
  ...
  document_ready( () => {
    ...
    Shiny.addCustomMessageHandler('dipsaus-swal-show', (params) => {
      ...
      // debug
      sweetalert_min_default()(swal_params)
        .then((value) => {
          // inputId is string, we don't check it
          Shiny.setInputValue(
...
/* harmony default export */ const streamsaver = (streamSaver);
...
function register_streamDownload(Shiny, debug = false) {
...
register_actionButtonStyled( src_Shiny, src_DEBUG );
register_compoundInput2( src_Shiny, src_DEBUG );
register_screenshot( src_Shiny, src_DEBUG );
register_set_input( src_Shiny, src_DEBUG );
register_swal( src_Shiny, src_DEBUG );
register_directoryInput( src_Shiny, src_DEBUG );
register_streamDownload( src_Shiny, src_DEBUG );
