#ifndef __RAVETOOLS_PARALLEL_TINYTHREAD__
#define __RAVETOOLS_PARALLEL_TINYTHREAD__
                             ...
                             std::size_t grainSize = 1)
{
   ...
   for (std::size_t i = 0; i<ranges.size(); ++i) {
      Reducer* pReducer = new Reducer(reducer, TinyParallel::Split());
...
#endif // __RAVETOOLS_PARALLEL_TINYTHREAD__
